              ...
              <SidebarMenuItem>
                <SidebarMenuButton asChild className={buttonStyles}>
                  <a
                    ...
                    aria-current={
                      currentPath === ROUTES.dashboard ? "page" : undefined
                    }
                  >
                    <ChartLine
                      className={
              ...
              <SidebarMenuItem>
                <SidebarMenuButton asChild className={buttonStyles}>
                  <a
                    ...
                    aria-current={
                      currentPath === ROUTES.stations ? "page" : undefined
                    }
                  >
                    <RadioTower
                      className={
              ...
              <SidebarMenuItem>
                <SidebarMenuButton asChild className={buttonStyles}>
                  <a
                    ...
                    aria-current={
                      currentPath === ROUTES.parameters ? "page" : undefined
                    }
                  >
                    <SlidersHorizontal
                      className={
              ...
              <SidebarMenuItem>
                <SidebarMenuButton asChild className={buttonStyles}>
                  <a
                    ...
                    aria-current={
                      currentPath === ROUTES.alerts ? "page" : undefined
                    }
                  >
                    <Bell
                      className={
              ...
              <SidebarMenuItem>
                <SidebarMenuButton asChild className={buttonStyles}>
                  <a
                    ...
                    aria-current={
                      currentPath === ROUTES.reports ? "page" : undefined
                    }
                  >
                    <Newspaper
                      className={
