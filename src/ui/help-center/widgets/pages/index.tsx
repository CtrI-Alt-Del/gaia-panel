    ...
    <article className="mx-auto px-4 py-12 bg-white sm:px-6 lg:px-8 max-w-5xl">
      ...
      <div className="text-center mb-16">
        ...
        <p className="text-xl text-slate-500 max-w-2xl mx-auto">
          Bem-vindo à documentação oficial. Aqui você encontra guias detalhados sobre como operar, configurar e extrair o máximo do seu sistema de monitoramento.
        </p>
      </div>
        ...
        <div className="grid gap-6 md:grid-cols-2">
          <div className="bg-white p-6 rounded-xl shadow-sm border border-slate-100">
            ...
            <p className="text-slate-600 text-sm leading-relaxed">
              Recomendamos iniciar pelo <strong>Dashboard</strong> para ter uma visão geral dos dados. Em seguida, acesse a seção de <strong>Estações</strong> para verificar se todos os seus equipamentos estão online e configurados corretamente.
            </p>
          </div>
          ...
          <div className="bg-white p-6 rounded-xl shadow-sm border border-slate-100">
            ...
            <p className="text-slate-600 text-sm leading-relaxed">
              ...
              <br/><br/>
              <span className="text-indigo-600 font-medium">• Alarmes</span> são as <strong>regras</strong> que você configura (ex: "Avise se chover muito").
              <br/>
              <span className="text-orange-600 font-medium">• Alertas</span> são as <strong>notificações</strong> que o sistema gera quando essa regra acontece.
            </p>
          </div>
        </div>
      </section>
