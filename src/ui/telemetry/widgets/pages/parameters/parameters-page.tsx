...
import {
  ...
  getParameterVisuals,
  palette,
} from "../../components/parameter/parameter-visuals";
        ...
        <table className="min-w-full text-left text-sm">
          ...
          <tbody>
            ...
            {items.map((p) => {
              ...
              const styles = palette[color as keyof typeof palette];
                ...
                <tr key={p.id} className="border-t border-stone-200">
                  <td className="px-4 py-3 align-top">
                    <div className="flex items-center gap-3">
                      <span
                        className={`inline-flex size-9 items-center justify-center rounded-xl ${styles.iconBg} ring-1 ${styles.iconRing}`}
                      >
                  ...
                  <td className="px-4 py-3 align-top">
                    <div className="flex justify-end gap-3 text-sm">
                      <button
                        type="button"
                        className="inline-flex items-center gap-1 text-stone-700 hover:underline cursor-pointer"
                      >
